...
static int	plnA_boxV_update( pln_type *pl, float dt, vec2f_type *p0, vec2f_type *v, float dx, box2f_type *b );




int
plnA_boxV( plnA_type *apl, vec2f_type *p0, vec2f_type *v, float dx, box2f_type *b )
{
int	i;
	...
	for( i = 0; i < apl->nA ; i++ )
		plnA_boxV_update( apl->a[i], 1.0, p0, v, dx, b );
...
int
pln_boxV( pln_type *pl, vec2f_type *p0, vec2f_type *v, float dx, box2f_type *b )
{

	b->x0 = b->x1 = b->y0 = b->y1 = 0;

	plnA_boxV_update( pl, 1.0, p0, v, dx, b );
...
static int
plnA_boxV_update( pln_type *pl, float dt, vec2f_type *p0, vec2f_type *v, float dx, box2f_type *b )
{
